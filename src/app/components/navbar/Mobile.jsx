...
const Mobile = () => {
  ...
  return (
    <div className="container-navbarMobile">
      {open ? (
        <svg
      ...
      <div className={`${open ? "container-navbarMobile_div-on" : "container-navbarMobile_div-off"} container-navbarMobile_div`}>
        <Link className="container-navbarMobile_div_link" href=''>
        ...
        <div className={`container-navbarMobile_div_categories ${openPets ? 'categories-on' : 'categories-off'}`}>
          <Link className="container-navbarMobile_div_categories_link" href='/products/perros'>
          ...
          <Link className="container-navbarMobile_div_categories_link" href='/products/cats'>
          ...
          <Link className="container-navbarMobile_div_categories_link" href='/products/birds'>
          ...
          <Link className="container-navbarMobile_div_categories_link" href='/products/fishes'>
          ...
          <Link className="container-navbarMobile_div_categories_link" href='/products/others'>
